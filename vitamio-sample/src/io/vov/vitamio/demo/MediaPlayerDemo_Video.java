	...
	private void playVideo(Integer Media) {
		...
		try {
			...
			case LOCAL_VIDEO:
				 ...
				 */
				path = MediaPlayerDemo_Video.getTCardPath()+"/1.mp4";
				if (path == "") {
			...
			case STREAM_VIDEO:
				 ...
				 * 
				 */
				path = "http://27.221.48.184/youku/6977CA38D1938830D4AF7F2594/0300080100518A22B8157501DB0DC9BCE9E3A6-5F6A-B3A2-AD5F-29735AF6113C.mp4";
				if (path == "") {
					// Tell the user to provide a media file URL.
